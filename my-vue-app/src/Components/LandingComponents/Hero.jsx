...
export const Hero = () => {
  ...
  return (
    ...
    <div className="bg-indigo-600 bg-cover h-auto">
      <header className="absolute inset-x-0 top-0 z-50 sticky bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-60 ">
        <nav
        ...
        >
          <div className="flex items-center lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <img
                ...
                src="https://img.icons8.com/external-vitaliy-gorbachev-lineal-vitaly-gorbachev/60/ffffff/external-usb-photography-vitaliy-gorbachev-lineal-vitaly-gorbachev.png"
                alt=""
              />
            </a>
            <h1 className="ml-2 h-8 w-auto text-4xl text-white tracking-wider">
              <b>CONNTECH</b>
            </h1>
          </div>
          ...
          <div className=" text-lg flex items-center hidden lg:flex lg:flex-1 lg:justify-end">
            <Link to="/register">
              <button className="text-xl font-size: 1.25rem; font-semibold leading-6 text-white mr-10">
      ...
      >
        ...
        <div className="text-center flex flex-col items-center justify-center">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
            CONECTAMOS TALENTOS CON EL MUNDO TECH.
          </h1>
          <p className="mt-6 text-2xl font-size: 1.25rem; leading-8 text-slate-100 text-justify">
